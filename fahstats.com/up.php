...
# test if the db is in maintenance
...
if ($in_maintenance == 't') {
   echo <<<html
   <p style="text-align:center;margin: 5em;font-size:200%;">
   Database in maintenance. Come back in one hour.
   </p>
html;
   exit;
}
echo <<<html
</p><div style="margin-top:0;margin-bottom:0.5;padding:0;">
<img
  src="/upchart.php?id={$donor}&amp;l=$lastDayUpdate"
...
unset($big);
?>
<table class="tabela" cellspacing="0" cellpadding="0" style="margin:1.5em auto;padding:0;">
<tr>
<td class="top">
...
<table class="tabela" cellspacing="0" cellpadding=""
  style="margin:1.5em auto 0;padding:0;">
<tr>
<td class="top">
